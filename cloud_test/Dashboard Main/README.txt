...
DASHBOARD MAIN --> OCEAN'S MONITORING FOLDER
...
//
* api.json              --> sample json archive for test data handling
//
* /plugins, /dist   {   --> contains only the needed plugins and css/js for functionality
